...
public class Notificar {
    public static void notificar(Item mandar)
    {
        ...
        try {
            ...
            urlBuilder.append("id=").append(String.format("%09d", mandar.getId()));
...
//            }
    ...
    public static void notificar(Item mandar, long id)
    {
        Usuario usuario = UsuarioService.getUserData((int) id);
        String email = usuario.getEmail();
        String nome = usuario.getNome();
        final String username = "sigap.cefetmg@gmail.com";
        final String password = "ieft hgoy ojjw htxt";
        ...
        try {
            ...
            message.setFrom(new InternetAddress(username));
            message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(email));
            message.setSubject("Encontramos este item com seu nome");
            message.setSubject("Encontramos este item com seu nome");
