        ...
        <div class="relatorio">
            <%
                ...
                if (dataInicioStr != null && dataFimStr != null) {
                    ...
                    String dbUrl = "jdbc:postgresql://db:5432/sigap"; // Ajuste conforme seu ambiente Docker
                    String dbUser = "sigap";
                    ...
                    try {
                        ...
                        while (rs.next()) {
                            ...
                            item.put("dataPerdido", rs.getDate("dataPerdido") != null ? rs.getDate("dataPerdido").toString() : "N/A");
                            item.put("dataAchado", rs.getDate("dataAchado") != null ? rs.getDate("dataAchado").toString() : "N/A");
